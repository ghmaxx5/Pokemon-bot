...
async function execute(message, args) {
  ...
  if (mentioned.id === userId) return message.reply("You can't give credits to yourself!");
  ...
  if (sender.rows[0].balance < amount) return message.reply("You don't have enough credits!");
  ...
  message.reply(`You gave **${amount.toLocaleString()}** credits to ${mentioned}!`);
}

module.exports = { name: "give", aliases: ["pay", "send"], description: "Give credits to another user", execute };
